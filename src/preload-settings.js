...
contextBridge.exposeInMainWorld("settingsAPI", {
  ...
  openMacTypingPrivacy: () => ipcRenderer.invoke("settings:open-mac-typing-privacy"),
  ...
  runProviderUsageRefreshNow: () => ipcRenderer.invoke("settings:run-provider-usage-refresh-now"),
  previewProviderUsageHud: () => ipcRenderer.invoke("settings:preview-provider-usage-hud"),
  getProviderUsageStatus: () => ipcRenderer.invoke("settings:get-provider-usage-status"),
