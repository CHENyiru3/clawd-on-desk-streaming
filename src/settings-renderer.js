...
const STRINGS = {
  en: {
    ...
    rowTimeCheckinEnabledDesc: "Generate a warm time-aware check-in every hour, using the past hour of sanitized clipboard history as the main evidence.",
    rowTimeCheckinSchedule: "Schedule",
    rowTimeCheckinScheduleDesc: "Every hour, throughout the day.",
